-- Revert migration 15's NULLIF fallback. SONIC API correctly returns cod_amount = 0
-- for prepaid orders. Using total_price as fallback was incorrectly treating prepaid
-- orders as COD. Only include orders where cod_amount > 0 (confirmed COD by SONIC API).
