-- Fix get_oos_last_7_days: product_inv CTE was summing inventory across all stores.
-- Now joins variants through products to scope inventory to the requested store.
